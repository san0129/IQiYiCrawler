...
namespace IQiYiCrawler
{
    public class PlayListSearch
    {
        ...
        public static List<PlayViewModel> Crawler(string url)
        {
            ...
            try
            {
                ...
                doc.LoadHtml(html);
                string fristPath = "//div[@class='info-intro']/h1/a";
                ...
                {
                    playList.Add(new PlayViewModel { Number =i, Url= nodePlayList[i].Attributes["href"].Value});
                }
